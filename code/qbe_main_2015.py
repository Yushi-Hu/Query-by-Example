...
if __name__ == "__main__":
    ...
    # get cosine distance
    cos_dist = cos_dist_dict(dev_hidden_fn, search_hidden_fn, windows=sample_len(), increment=increment, mode=mode)
    ...
    os.system(f"./score-TWV-Cnxe.sh {working_dir} groundtruth_quesst2015_dev -7.5")